...
HRESULT setStringA(char** _Dest, const char* _Source = NULL, unsigned int maxSize = 0);
HRESULT setStringW(wchar_t** _Dest, const wchar_t* _Source = NULL, unsigned int maxSize = 0);
...
typedef compare_case_insensitive < std::wstring >				wcompare;
typedef compare_case_insensitive < std::string >				scompare;
//typedef compare_case_insensitive < UnicodeString::String8 >		s8compare;
